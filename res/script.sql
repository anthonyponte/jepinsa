CREATE TABLE SUMMARY (
    ...
    RUC_TIPO VARCHAR(1) NOT NULL,
    RAZON_SOCIAL VARCHAR(100) NOT NULL,
    ZIP_NOMBRE VARCHAR(34) NOT NULL,
    ZIP BLOB(2048) NOT NULL,
    TICKET VARCHAR(100),
    STATUS_CODE VARCHAR(2),
    CONTENT_NOMBRE VARCHAR(36),
    CONTENT BLOB(4096),
...
CREATE TABLE BILL (
    ...
    RUC VARCHAR(11) NOT NULL,
    RUC_CODIGO VARCHAR(1) NOT NULL,
    RUC_DESCRIPCION VARCHAR(1500) NOT NULL,
    NOMBRE_COMERCIAL VARCHAR(1500),
