 ...
 * @author anthony
 */
public class SignIFrame extends JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setFrameIcon(FontIcon.of(RemixiconAL.DRAFT_LINE, 16, Color.decode("#f7d117")));
        setMaximumSize(null);
        setMinimumSize(null);
        ...
        btnFirmar.setIcon(FontIcon.of(RemixiconAL.DRAFT_LINE, 16, Color.decode("#FFFFFF")));
        btnFirmar.setText("Firmar");
        btnFirmar.setEnabled(false);
        btnFirmar.setMinimumSize(new Dimension(150, 30));
        btnFirmar.setPreferredSize(new Dimension(150, 30));
        ...
        btnImportar.setIcon(FontIcon.of(RemixiconAL.BILL_LINE, 16, Color.decode("#FFFFFF")));
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnFirmar, GroupLayout.Alignment.TRAILING, GroupLayout.DEFAULT_SIZE, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
        layout.setVerticalGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
            .addGroup(GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(btnFirmar, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
