...
public class Igv {
  ...
  private double tasa;
  private TipoIgv tipo;
  private TipoTributo tipoTributo;

  public Igv() {}

  public Igv(double base, double monto, double tasa, TipoIgv tipo, TipoTributo tipoTributo) {
    this.base = base;
    this.monto = monto;
    this.tasa = tasa;
    this.tipo = tipo;
  ...
  public TipoIgv getTipo() {
    return tipo;
  }

  public void setTipo(TipoIgv tipo) {
    this.tipo = tipo;
  }
