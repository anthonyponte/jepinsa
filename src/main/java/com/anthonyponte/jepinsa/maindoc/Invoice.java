  ...
  public Document getStructure(Factura factura) {
                ...
                new Element("SignatoryParty", cac)
                    ...
                    .addContent(
                        new Element("PartyName", cac)
                            .addContent(new Element("Name", cbc).setText(emisor.getNombre()))))
            .addContent(
    ...
    if (!emisor.getDireccion().equals("")) {
      ...
      tagRegistrationAddress
          .addContent(new Element("CitySubdivisionName", cbc).setText(emisor.getUrbanizacion()))
    ...
    if (!emisor.getDireccionEntrega().getDireccion().equals("")) {
      ...
      Element tagDeliveryTerms =
          new Element("DeliveryTerms", cac)
              // 62 Incoterm. C
              .addContent(new Element("ID", cbc).setText(emisor.getDireccionEntrega().getUbigeo()))
    ...
    if (!cliente.getDireccion().equals("")) {
      tagPartyLegalEntity2.addContent(
          new Element("RegistrationAddress", cac)
              ...
              .addContent(new Element("CountrySubentity", cbc).setText(cliente.getDepartamento()))
    ...
    Element tagPaymentTerms =
        new Element("PaymentTerms", cac).addContent(new Element("ID", cbc).setText("FormaPago"));
    ...
    if (!total.getCuota().getMonto().equals("0.00")) {
      Element tagAllowanceCharge =
          new Element("AllowanceCharge", cbc)
              .addContent(
                  new Element("ChargeIndicator", cbc).setText(total.getCuota().getIndicador()))
              .addContent(
